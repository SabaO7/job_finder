...
# ✅ Setup logging
logger = setup_logger("JobAggregator")

# ✅ File paths
CSV_FILE = "aggregator_companies.csv"
...
def create_scraper_agent():
    ...
    # ✅ Define tools before using them in `bind_tools()`
    tools = [
    ...
    # ✅ Now bind the tools correctly after defining them
    model = ChatOpenAI(model_name="gpt-4-turbo", temperature=0).bind_tools(tools)
